...
const Contact=()=>{
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_zyd1c64', 'template_37si1nb', formRef.current, 'VXfx69iljOYlUtRnd')
          .then((result) => {
              setSuccess(true)
          }, (error) => {
              setError(true)
    ...
    return (
        <motion.div  ref={ref} className="contact" variants={variants} initial="initial" whileInView="animate">
            <motion.div className="textContainer" variants={variants}>
                <motion.h1 variants={variants}>Let's Connect and Work Together</motion.h1>
                <motion.div className="item" variants={variants}>
                    <h2>Mail</h2>
                    <span>rajverma9719@gmail.com</span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>phone</h2>
                    <span>+91-8283088697</span>
                </motion.div>
            </motion.div>
